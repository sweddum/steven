  ...
  function (
    ...
    var aWidget = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        this.own(on(this.list, "footprintVisibilityChange", lang.hitch(this, this._footprintVisChange)));
        this.own(on(this.list, "opacityChange", lang.hitch(this, this._footprintOpacityChange)));
        html.addClass(this.list.domNode, "aloha-list");
        this._initial();
